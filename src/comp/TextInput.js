...
function TextInput  (props) {
    ...
    useEffect(()=> {
        ...
        var t_padding_left_focused=''
        switch (true){
            case (props.icon_left_component && icon_left_visible) : {
                t_padding_left_focused ='1.5em'; break;
            }
            case ("filled"==props.input_variant) : {
                t_padding_left_focused ='0.8em'; break;
            }
            case ("standard"==props.input_variant || !props.input_variant ) : {
                t_padding_left_focused ='0'; break;
            }
            default: {
                t_padding_left_focused ='2px'; break;
            }
        }

        t_padding_left_focused='    padding-left: '+t_padding_left_focused+' !important; '
